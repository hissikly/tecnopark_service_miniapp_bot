...
export function Cart() {
  ...
  return (
    <div className="pb-32 animate-in min-h-screen flex flex-col">
      ...
      <div className="p-4 space-y-4 flex-1">
        ...
        {selectedPlan === 'none' ? (
          ...
          <div className="bg-slate-800 rounded-2xl p-4 flex gap-4 border border-cyan-500/30">
             ...
             <div className="flex-1 flex flex-col justify-between">
               <div>
                 <div className="text-sm font-medium text-white">{TARIFFS[selectedPlan].title}</div>
                 <div className="text-xs text-slate-400 mt-1">{TARIFFS[selectedPlan].price} ₽ / {TARIFFS[selectedPlan].period}</div>
               </div>
      ...
      <div className="fixed bottom-[72px] left-0 right-0 max-w-md mx-auto p-4 bg-slate-900 border-t border-slate-800 z-40 pb-6">
