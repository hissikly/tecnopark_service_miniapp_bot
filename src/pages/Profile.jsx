        ...
        {isSubActive ? (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <h3 className="text-white font-medium">{TARIFFS[subscription.plan].title}</h3>
              <p className="text-xs text-slate-400 mt-1 max-w-[200px] truncate">{TARIFFS[subscription.plan].description}</p>
            </div>
