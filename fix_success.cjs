...
let content = fs.readFileSync('src/pages/Success.jsx', 'utf-8');
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-6 text-center z-50 animate-in">
      ...
      <p className="text-slate-400 mb-8 max-w-xs leading-relaxed">
        {planId === 'garantia' && 'Подписка Гарантия+ активирована для вашего нового устройства.'}
        {planId === 'postgarantia' && 'Подписка Постгарантия+ активирована. Ваша техника под расширенной защитой.'}
        {!planId && 'Спасибо за покупку в Технопарк!'}
      </p>
...
`
fs.writeFileSync('src/pages/Success.jsx', content);
console.log('Fixed Success.jsx');
