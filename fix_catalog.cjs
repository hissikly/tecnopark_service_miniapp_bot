...
const catalogContent = `import { useNavigate } from 'react-router-dom';
...
fs.writeFileSync('src/pages/Catalog.jsx', catalogContent);
console.log("Catalog updated with images layout!");
